...
class SeasonPass {
  ...
  static List<SeasonTier> buildDefaultTiers() {
    // Free track: stardust x16, box x12, emote x1, distributed across 30 tiers
    // Premium track: skins, effects, frames, nickname colors
  ...
  static SeasonReward _buildFreeReward(int tier) {
    ...
    // Tiers 5, 10, 20, 25: basic boxes (4 boxes total + extra in lower tiers)
    if (tier % 5 == 0 && tier != 15) {
      return SeasonReward(
        id: 'free_box_$tier',
        name: 'Star Box',
  ...
  static SeasonReward? _buildPremiumReward(int tier) {
    // Distribute premium rewards: skins at 5,15,25,30; effects at 10,20; frames at 7,17,27; colors at 3,13,23
